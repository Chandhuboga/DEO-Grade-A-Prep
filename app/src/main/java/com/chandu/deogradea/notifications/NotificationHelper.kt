...
object NotificationHelper {
    ...
    fun showInactivity(context: Context, day: Int) {
        show(
            ...
            text = "Day $day/95 \u2014 no progress detected. Open DEO GRADE A PREP and tick today's quest.",
            fullScreen = true
        )
    }
    ...
    fun showDanger(context: Context, day: Int, remaining: Int) {
        show(
            ...
            text = "Day $day/95 \u2014 $remaining objectives remaining. Failure risk: HIGH.",
            fullScreen = true
        )
    }
    ...
    fun showDailyQuest(context: Context, day: Int, slotLabel: String, summary: String) {
        show(
            ...
            title = "Day $day/95 \u2014 $slotLabel Quest Reminder",
            text = summary,
            fullScreen = false
        )
    }
